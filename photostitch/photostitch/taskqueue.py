  ...
  def __init__(self, payload=None, **kwargs):
    ...
    Args:
      ...
      eta: Absolute time when the Task should execute. May not be specified
        ...
        timezone-naive. For pull tasks, no worker is allowed to lease this
        task before the time indicated by eta.
      ...
      params: Dictionary of parameters to use for Task. For POST and PULL
        ...
        other methods, the parameters will be converted to a query string. May
      ...
      url: Relative URL where the webhook that should handle this task is
        ...
        a POST method. url can only be specified for push tasks.
...
class Queue(object):
  ...
  def lease_tasks(self, lease_seconds, max_tasks):
    ...
    This method can only be performed on a pull Queue. All non-pull tasks in
